...
return new class extends Migration {
    ...
    {
        Schema::create('vendedor_wallets', function (Blueprint $table) {
            $table->id();
            $table->foreignId('vendedor_id')->unique()->constrained('vendedores')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('vendedor_wallets');
    }
};