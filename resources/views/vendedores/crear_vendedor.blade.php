    ...
    <div class="md:w-1/2 w-full flex flex-col min-h-screen rounded-4xl motion-preset-slide-right">
        ...
        <div class="flex-1 flex flex-col items-center justify-center gap-y-6 mx-10">
            ...
            <div class="text-center">
                <h1 class="font-serif text-2xl">Conviértete en Vendedor</h1>
                <h2 class="font-inconsolata text-sm">
                    Recomienda libros y gana comisiones por cada venta
                </h2>
            </div>
                ...
                <form method="POST" action="{{ route('vendedores_store') }}" class="text-center" novalidate>
                    ...
                    <div data-stepper-content-item='{"index":1}' class="space-y-4">
                        ...
                        <div class="input-floating">
                            <input type="text" name="nombre_publico" class="input" placeholder=" " required>
                            <label class="input-floating-label">Nombre público</label>
                        </div>
